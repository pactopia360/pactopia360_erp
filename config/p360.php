...
return [
    ...
    'pricing' => [
        ...
        'plans' => [
            ...
            'PRO' => [
                'mensual' => (float) env('P360_PRICE_PRO_M', 999),   // <-- AJUSTA
                'anual'   => (float) env('P360_PRICE_PRO_A', 9990),  // <-- AJUSTA
            ],
            'PREMIUM' => [
                'mensual' => (float) env('P360_PRICE_PREMIUM_M', 1499),  // <-- AJUSTA
                'anual'   => (float) env('P360_PRICE_PREMIUM_A', 14990), // <-- AJUSTA
            ],
        ],
    ],
];
