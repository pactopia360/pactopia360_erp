...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_clientes')->create('sat_user_report_items', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql_clientes')->dropIfExists('sat_user_report_items');
    }
};