    ...
    <section class="page-card" aria-label="Filtros y KPIs">
      <div class="filters-bar" role="group" aria-label="Filtros del panel">
        <div class="filters-left">
          ...
          <select id="fMonths" class="select"><option value="3">3 meses</option><option value="6">6 meses</option><option value="12" selected>12 meses</option><option value="24">24 meses</option></select>

          <label for="fPlan" class="lbl">Plan</label>
          <select id="fPlan" class="select"><option value="all" selected>Todos</option></select>
    ...
    <section class="charts-grid" aria-label="Métricas">
      <article class="chart-card" data-span="2" aria-labelledby="chartIncomeTitle">
        <div class="chart-head sticky">
          ...
          <div class="chart-tools"><button class="btn" id="btnIncomeResetZoom" type="button">Reset zoom</button><button class="btn" id="btnIncomePNG" type="button">PNG</button><button class="btn" id="btnIncomeCSV" type="button">CSV</button></div>
        </div>
      ...
      <article class="chart-card" aria-labelledby="chartStampsTitle">
        <div class="chart-head sticky">
          ...
          <div class="chart-tools"><button class="btn" id="btnStampsResetZoom" type="button">Reset zoom</button><button class="btn" id="btnStampsPNG" type="button">PNG</button><button class="btn" id="btnStampsCSV" type="button">CSV</button></div>
        </div>
      ...
      <article class="chart-card" aria-labelledby="chartPlansTitle">
        <div class="chart-head sticky">
          ...
          <div class="chart-tools"><button class="btn" id="btnPlansPNG" type="button">PNG</button><button class="btn" id="btnPlansCSV" type="button">CSV</button></div>
        </div>
      ...
      <article class="chart-card" aria-labelledby="chartIncomePlanTitle">
        <div class="chart-head sticky">
          ...
          <div class="chart-tools"><button class="btn" id="btnIncomePlanPNG" type="button">PNG</button><button class="btn" id="btnIncomePlanCSV" type="button">CSV</button></div>
        </div>
      ...
      <article class="chart-card" aria-labelledby="chartNewClientsTitle">
        <div class="chart-head sticky">
          ...
          <div class="chart-tools"><button class="btn" id="btnNewClientsPNG" type="button">PNG</button><button class="btn" id="btnNewClientsCSV" type="button">CSV</button></div>
        </div>
      ...
      <article class="chart-card" aria-labelledby="chartTopClientsTitle">
        <div class="chart-head sticky">
          ...
          <div class="chart-tools"><button class="btn" id="btnTopClientsPNG" type="button">PNG</button><button class="btn" id="btnTopClientsCSV" type="button">CSV</button></div>
        </div>
        <div class="chart-wrap"><canvas id="chartTopClients"></canvas></div>
      </article>

      <article class="chart-card" aria-labelledby="chartYTDTitle">
        <div class="chart-head sticky"><div class="widget-title" id="chartYTDTitle"><span aria-hidden="true">📈</span> <span class="t">Ingresos acumulados YTD</span></div></div>
        <div class="chart-wrap"><canvas id="chartYTD"></canvas></div>
      </article>

      <article class="chart-card" data-span="2" aria-labelledby="chartDailyTitle">
        <div class="chart-head sticky"><div class="widget-title" id="chartDailyTitle"><span aria-hidden="true">📅</span> <span class="t">Comparativa diaria (mes actual)</span></div></div>
        <div class="chart-wrap"><canvas id="chartDaily"></canvas></div>
      </article>

      <article class="chart-card" aria-labelledby="chartMoMTitle">
        <div class="chart-head sticky"><div class="widget-title" id="chartMoMTitle"><span aria-hidden="true">📊</span> <span class="t">Variación mensual (%)</span></div></div>
    ...
    <section class="table-card page-shell" aria-labelledby="tblClientsTitle">
      <div class="table-head">
        ...
        <div class="table-actions">
          <div class="search"><span aria-hidden="true">🔍</span><input type="text" id="searchClients" placeholder="Buscar..." aria-label="Buscar cliente"></div>
          <button id="btnExport" class="btn-export" type="button">⬇ Exportar</button>
        </div>
      </div>
      <div class="table-wrap">
        <table class="table hover striped" id="clientsTable">
          <thead><tr><th>#</th><th>Empresa</th><th>RFC</th><th>Timbres</th><th>Última actividad</th><th>Estado</th></tr></thead>
          <tbody id="clientsTbody"><tr id="clientsEmptyRow"><td colspan="6" class="empty">Sin datos</td></tr></tbody>
        </table>
      </div>
    </section>
  </div>
  ...
  <div id="modalIncome" class="modal" aria-hidden="true">
    ...
    <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="modalIncomeTitle">
      <div class="modal-head">
        <div><div class="modal-title" id="modalIncomeTitle">Ingresos — <span id="modalIncomeMonth">YYYY-MM</span></div><div class="modal-sub text-muted">Pagos del mes seleccionado</div></div>
        <button class="modal-close" type="button" data-close aria-label="Cerrar">✖</button>
      </div>
      <div class="modal-tools">
        <div class="search"><span aria-hidden="true">🔍</span><input type="text" id="incomeModalSearch" placeholder="Buscar cliente / RFC / referencia..." aria-label="Buscar en pagos"></div>
        <div class="spacer"></div><button class="btn" id="incomeModalExport" type="button">Exportar CSV</button>
      </div>
      <div class="modal-body">
        <div class="table-wrap">
          <table class="table dense hover" id="incomeModalTable">
            <thead><tr><th data-sort="fecha">Fecha</th><th data-sort="cliente">Cliente</th><th data-sort="rfc">RFC</th><th data-sort="metodo">Método</th><th data-sort="estado">Estado</th><th data-sort="monto">Monto</th></tr></thead>
            <tbody id="incomeModalTbody"><tr id="incomeModalEmpty"><td colspan="6" class="empty">Sin pagos</td></tr></tbody>
            <tfoot><tr><th colspan="5" style="text-align:right">Total</th><th id="incomeModalTotal">-</th></tr></tfoot>
          </table>
        </div>
      </div>
    </div>
