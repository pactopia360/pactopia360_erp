<div class="invx-modal" id="bulkSendModal" aria-hidden="true">
    ...
    <div class="invx-modal__dialog invx-modal__dialog--sm">
        <div class="invx-modal__head">
            <div>
                <h3 class="invx-modal__title">Envío masivo</h3>
                <p class="invx-modal__sub">Envía las facturas seleccionadas a uno o varios correos.</p>
            </div>
        ...
        <div class="invx-modal__body">
            <form method="POST" action="{{ $routeBulkSend }}" id="invxBulkSendForm" class="invx-form-grid invx-form-grid--compact">
                @csrf

                <div class="invx-field invx-field--span-12">
                    <div class="invx-floating">
                        <input id="invxBulkTo" type="text" name="to" class="invx-input" value="{{ old('to') }}" placeholder=" ">
                        <label for="invxBulkTo">Correos destino</label>
                    </div>
                </div>

                <div class="invx-field invx-field--span-12">
                    <input type="hidden" name="invoice_ids" id="invxBulkInvoiceIds" value="">
                    <div class="invx-help">
                ...
                <div class="invx-field invx-field--span-12">
                    <div class="invx-form-actions">
                        ...
                        <button type="submit" class="invx-btn invx-btn--success" id="invxBulkSendBtn" disabled>Enviar selección</button>
                    </div>
                </div>
            </form>
        </div>
