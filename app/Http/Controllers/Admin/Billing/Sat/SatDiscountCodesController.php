...
final class SatDiscountCodesController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('admin.billing.sat.discounts.index', [
            'rows'  => $rows,
            'q'     => $q,
            'scope' => $scope,
            'active'=> $act,
    ...
    public function create(): View
    {
        ...
        return view('admin.billing.sat.discounts.form', [
            'mode' => 'create',
            'row'  => $row,
        ]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.billing.sat.discounts.index')
    ...
    private function validatePayload(Request $request, ?int $id = null): array
    {
        ...
        // Normalizar fechas a datetime (inicio 00:00, fin 23:59:59)
