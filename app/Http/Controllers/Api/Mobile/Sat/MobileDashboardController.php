...
class MobileDashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $hero = [
            ...
            'plan' => strtoupper($account->plan_actual ?? $account->plan ?? 'FREE'),
            'status' => $account->estado_cuenta ?? 'activa',
            'next_payment' => optional($account->next_invoice_date)->format('Y-m-d'),
        ];
        ...
        // =========================================
        $health = [
            'status' => $account->is_blocked ? 'blocked' : 'ok',
            'message' => $account->is_blocked
